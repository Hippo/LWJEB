...
public final class EventBus {
    ...
    public EventBus publish(final Object event) {
        ...
        if(registry instanceof ConcurrentEventRegistry){
            subscriptions = ((ConcurrentEventRegistry)registry).getEventMap().get(event.getClass());
        }else if(registry instanceof ImmediateEventRegistry){
            subscriptions = ((ImmediateEventRegistry)registry).getEventMap().get(event.getClass());
        }
     ...
     * </p>
     * <p1>
     *     The {@link EventRegistry} will also be constructed.
     * </p1>
     *
     * @return  {@code this}.
     */
