...
/**
 * <h1>The Method Based MessageHandler Collector.</h1>
 * An implementation of {@link SubscriptionCollector} that collects {@link MethodBasedMessageHandler}s.
 *
 * @author Hippo
 * @since 11/6/2018
 */
    ...
    public List<MessageHandler> collect(Object parent) {
        ...
        for (Method method : parent.getClass().getDeclaredMethods()) {
            if(method.isAnnotationPresent(Collect.class) && method.getParameterCount() == 1) {
                ...
                messageHandlers.add(new MethodBasedMessageHandler(parent, topic, method));
            }
        }
